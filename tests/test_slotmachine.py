...
class ScheduleTalksTestCase(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        solved_second = self.schedule_and_basic_asserts(talk_defs, talk_permissions,
                                                        avail_slots, old_talks=solved)
    ...
    def test_speaker_clash(self):
        ...
        solved = self.schedule_and_basic_asserts(talk_defs, talk_permissions,
